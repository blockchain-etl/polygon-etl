...
with double_entry_book as (
    SELECT 
      ...
      0 AS managed_change
    FROM `blockchain-etl.polygon_balancer.V2_Vault_event_PoolBalanceChanged`
    ...
    SELECT 
      ...
      0 AS managed_change
    FROM `blockchain-etl.polygon_balancer.V2_Vault_event_Swap`
    ...
    FROM `blockchain-etl.polygon_balancer.V2_Vault_event_PoolBalanceManaged`
),
