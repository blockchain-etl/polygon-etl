import pytest
from polygonetl.ipfs.origin import get_origin_ipfs_client
from polygonetl.jobs.export_origin_job import ExportOriginJob
from polygonetl.jobs.exporters.origin_exporter import (
...
from tests.polygonetl.job.mock_ipfs_client import MockIpfsClient
...
@pytest.mark.parametrize(
    "start_block,end_block,batch_size,output_format,resource_group,web3_provider_type,ipfs_client_type",
    [
        (10014847, 10014847, 1, "json", "blocks_with_logs", "mock", "mock"),
        skip_if_slow_tests_disabled(
            (10014847, 10014847, 1, "json", "blocks_with_logs", "infura", "ipfs")
        ),
    ],
)
